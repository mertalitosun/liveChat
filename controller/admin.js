...
exports.post_admin_edit_suggest = async(req,res)=>{
    ...
    try{
        ...
        res.redirect("/settings/suggestion-messages")
    }catch(err){
        console.log(err)
    }
}
exports.get_admin_edit_suggest = async(req,res)=>{
    ...
    try{
        ...
        res.render("admin/settings/suggestion-messages/suggestion-edit",{
...
exports.get_admin_create_suggest = async(req,res)=>{
    res.render("admin/settings/suggestion-messages/suggestion-create",{
...
exports.get_admin_delete_suggest = async(req,res)=>{
    ...
    try{
        ...
        res.render("admin/settings/suggestion-messages/suggestion-delete",{
...
exports.get_suggestion_messages = async function(req,res){
    try{
        const suggestions = await Suggestion.findAll()
        res.render("admin/settings/suggestion-messages/suggestion-messages",{
            title:"Önerilen Mesajlar",
            suggestions:suggestions,
        })
    }catch(err){
        console.log(err)
